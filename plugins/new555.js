...
┗━━━━━━━━━━━━━━━━━➤◍◉➤
    ...
    bot.ev.on("messages.upsert", async (update) => {
      ...
      if (isReply) {
        ...
        if (userChoice === '1') {
          await bot.sendMessage(from, { video: { url: dl_link.download_mp4_1 }, caption: "> Avishka_X-MD SD video!" });
...
try{
 ...
 await conn.sendMessage(from, { text: '📥 *Avishka_X-ᴍᴅ ιѕ ᴅᴏᴡɴʟᴏᴅɪɴɢ...* 📥' }, { quoted: mek });

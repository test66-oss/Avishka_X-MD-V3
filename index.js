...
async function connectToWA() {
    ...
    console.log("💥✔️ Avishka_X-MD - Session Download Completed...");
    ...
    conn.ev.on('connection.update', (update) => {
        ...
        if (connection === 'close') {
            ...
            console.log('✅ Avishka_X-MD - Avishka_X-MD Sucessfull Conected Your Device...')
            const path = require('path');
...
app.listen(port, () => console.log(`✔️ Avishka_X-MD - Server Running...`));
setTimeout(() => {
    connectToWA()
}, 4000);
